...
export default () => {
  ...
  const Window = (
    ...
    if (x + w > monitors[overviewMonitor.value].width)
      w = monitors[overviewMonitor.value].width - x;
    if (y + h > monitors[overviewMonitor.value].height)
      h = monitors[overviewMonitor.value].height - y;
